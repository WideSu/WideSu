...
- ✨ I'm doing a **full-time internship(6th Dec 2021- 6th Jun 2022)** as a **Machine Learning Engineer Intern** in [IKAS Industry](http://www.ikasinfo.com/), which is a company doing **algorithms in the semi-conductor domain**. I have done two projects. One is **predictive maintenance** for time series data of machines. The other is the **temperature adjustment algorithm** for producing wafers.
